      ...
      <div class="nav-bar">
        ...
        <div class="nav-list">
          ...
          <ul>
            ...
            <li><a href=" View_volunteerDetail.php"data-after="GetInvolved">Volunteers</a></li>
            <li><a href="Donors.php" data-after="About">Donors</a></li>
            <li><a href="RegisteredUser.php" data-after="Contact">RegisteredUsers</a></li>
			<?php echo " " . $_SESSION['username'] . ""; ?>
			<li><a href="logoutAdmin.php" data-after="SignIn">logout</a></li>
