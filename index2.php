      ...
      <div class="nav-bar">
        ...
        <div class="nav-list">
          ...
          <ul>
			...
			<li><a href="registrationpage2.php" data-after="SignUp">SignUp</a></li>
			<li><a href="Design.php" data-after="SignIn">SignIn</a></li>
			<li><a href="Admin_Login.php" data-after="SignIn">Admin Login</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section id="Home">
    <div class="Home container">
      <div>
        ...
        <h1> <span></span></h1>
        <a href="loginpage.php" type="button" class="cta">DONATE</a>
      </div>
    </div>
  </section>
  <section id="Campaign">
